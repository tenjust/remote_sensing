...
#     file_name = f"202309_0{}_transparent_mosaic_group1.tif"
...
#     delete_main(folder_path)

# DNDF ==============================================================================================

# folder_path = "D:\\Yehmh\\202309_大農大富RGB&NDVI\\pix4d file\\001"
# os.makedirs(os.path.join(folder_path, "5m_5m"))
# file_name = "202309_001_transparent_mosaic_group1.tif"
# split_tif(folder_path, file_name, 5)
# print("1 splitted")

# for i in range(2, 10):
#     folder_path = f"D:\\Yehmh\\202309_大農大富RGB&NDVI\\pix4d file\\00{i}"
#     os.makedirs(os.path.join(folder_path, "5m_5m"))
#     file_name = f"00{i}_transparent_mosaic_group1.tif"
#     split_tif(folder_path, file_name, 5)
#     print(i, " splitted")

# for i in range(10, 16):
#     folder_path = f"D:\\Yehmh\\202309_大農大富RGB&NDVI\\pix4d file\\0{i}"
#     os.makedirs(os.path.join(folder_path, "5m_5m"))
#     file_name = f"0{i}_transparent_mosaic_group1.tif"
#     split_tif(folder_path, file_name, 5)
#     print(i, "splitted")
...
# clean data
for i in range(1, 10):
    folder_path = f"D:\\Yehmh\\202309_大農大富RGB&NDVI\\pix4d file\\00{i}\\5m_5m"
    delete_main(folder_path)
    print(i, " cleaned")

for i in range(10, 16):
    folder_path = f"D:\\Yehmh\\202309_大農大富RGB&NDVI\\pix4d file\\0{i}\\5m_5m"
    delete_main(folder_path)
    print(i, " cleaned")